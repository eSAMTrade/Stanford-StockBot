...
# LSTM_7 = LSTM_Model_MS(tickerSymbol = tickeranalysis, start = start, end = end, depth = 0, naive = True)
# LSTM_7.full_workflow_and_plot()
# LSTM_7.plot_bot_decision()
#
# LSTM_8 = LSTM_Model_MS(tickerSymbol = tickeranalysis, start = start, end = end, depth = 0)
# LSTM_8.full_workflow_and_plot()
# LSTM_8.plot_bot_decision()
#
# LSTM_9 = LSTM_Model_MS(tickerSymbol = tickeranalysis, start = start, end = end, depth = 1)
